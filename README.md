...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6370&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyathena-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyathena` can be installed with `conda`:
...
```
mamba install pyathena
```

It is possible to list all of the versions of `pyathena` available on your platform with `conda`:
...
```
mamba search pyathena --channel conda-forge
```
...
mamba repoquery search pyathena --channel conda-forge

# List packages depending on `pyathena`:
mamba repoquery whoneeds pyathena --channel conda-forge

# List dependencies of `pyathena`:
mamba repoquery depends pyathena --channel conda-forge
```
